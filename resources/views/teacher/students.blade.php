...
<div class="max-w-7xl mx-auto">
    ...
    <div class="bg-white border border-border rounded-xl shadow-sm overflow-hidden">
            ...
            <table class="w-full text-sm text-left">
                ...
                <tbody class="divide-y divide-border">
                    <tr class="hover:bg-muted/30 transition-colors">
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-3">
                                <div class="w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center text-blue-600 font-bold">A</div>
                                <span class="font-medium text-foreground">Ahmad Fauzi</span>
                            </div>
                        </td>
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-2">
                                <div class="w-24 h-2 bg-muted rounded-full overflow-hidden">
                                    <div class="bg-blue-500 h-full" style="width: 93%"></div>
                                </div>
                                <span class="text-xs font-medium">93%</span>
                            </div>
                        </td>
                        <td class="px-6 py-4 text-yellow-600 font-medium">3 Jurnal</td>
                        <td class="px-6 py-4 text-right space-x-2">
                            <button class="px-3 py-1 bg-blue-50 text-blue-600 rounded hover:bg-blue-100 transition-colors font-medium text-xs">Detail</button>
                            <button class="px-3 py-1 bg-indigo-50 text-indigo-600 rounded hover:bg-indigo-100 transition-colors font-medium text-xs">Nilai</button>
                        </td>
                    </tr>
                    ...
                    <tr class="hover:bg-muted/30 transition-colors">
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-3">
                                <div class="w-8 h-8 bg-pink-100 rounded-full flex items-center justify-center text-pink-600 font-bold">S</div>
                                <span class="font-medium text-foreground">Siti Nurhaliza</span>
                            </div>
                        </td>
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-2">
                                <div class="w-24 h-2 bg-muted rounded-full overflow-hidden">
                                    <div class="bg-blue-500 h-full" style="width: 87%"></div>
                                </div>
                                <span class="text-xs font-medium">87%</span>
                            </div>
                        </td>
                        <td class="px-6 py-4 text-yellow-600 font-medium">5 Jurnal</td>
                        <td class="px-6 py-4 text-right space-x-2">
                            <button class="px-3 py-1 bg-blue-50 text-blue-600 rounded hover:bg-blue-100 transition-colors font-medium text-xs">Detail</button>
                            <button class="px-3 py-1 bg-indigo-50 text-indigo-600 rounded hover:bg-indigo-100 transition-colors font-medium text-xs">Nilai</button>
                        </td>
                    ...
                    <tr class="hover:bg-muted/30 transition-colors">
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-3">
                                <div class="w-8 h-8 bg-green-100 rounded-full flex items-center justify-center text-green-600 font-bold">B</div>
                                <span class="font-medium text-foreground">Budi Santoso</span>
                            </div>
                        </td>
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-2">
                                <div class="w-24 h-2 bg-muted rounded-full overflow-hidden">
                                    <div class="bg-blue-500 h-full" style="width: 76%"></div>
                                </div>
                                <span class="text-xs font-medium">76%</span>
                            </div>
                        </td>
                        <td class="px-6 py-4 text-yellow-600 font-medium">2 Jurnal</td>
                        <td class="px-6 py-4 text-right space-x-2">
                            <button class="px-3 py-1 bg-blue-50 text-blue-600 rounded hover:bg-blue-100 transition-colors font-medium text-xs">Detail</button>
                            <button class="px-3 py-1 bg-indigo-50 text-indigo-600 rounded hover:bg-indigo-100 transition-colors font-medium text-xs">Nilai</button>
                        </td>
        ...
        <div class="px-6 py-4 border-t border-border flex items-center justify-between text-sm text-muted-foreground">
            <span>Menampilkan 3 dari 24 siswa</span>
            <div class="flex items-center gap-2">
