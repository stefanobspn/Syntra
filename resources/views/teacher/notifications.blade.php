...
<div class="max-w-4xl mx-auto">
    <div class="flex items-center justify-between mb-8">
        ...
        <form action="{{ route('teacher.notifications.mark_read') }}" method="POST">
            @csrf
        ...
        <div class="border rounded-xl p-5 flex gap-4 transition-colors {{ is_null($notification->read_at) ? 'bg-blue-50/50 border-blue-100 hover:bg-blue-50' : 'bg-white border-border hover:bg-muted/50' }}">
            <div class="mt-1">
                <div class="w-10 h-10 rounded-full flex items-center justify-center {{ is_null($notification->read_at) ? 'bg-blue-100' : 'bg-gray-100 opacity-70' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="{{ is_null($notification->read_at) ? 'text-blue-600' : 'text-gray-600' }}"><rect width="8" height="4" x="8" y="2" rx="1" ry="1"/><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"/><path d="M12 11h4"/><path d="M12 16h4"/><path d="M8 11h.01"/><path d="M8 16h.01"/></svg>
                </div>
            </div>
            <div class="flex-1">
